...
export default function Navigation() {
  ...
  return (
    <Navbar expand="lg">
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar">
          <Nav className="m-auto">
            {currentUser ? (
              // If user is logged in, show navigation links for dogs, events, profile, and logout
              <>
              ...
              // If user is not logged in, show navigation links for login and register
              <>
      ...
      {showAlert && (
        // Show a success alert with the greeting message
